...
const implementation: MachineOptions < IMachineContext, IMachineEvent > = {
    actions: {
        ...
        setCurrentStateUpdateReservation: assign((ctx) => ({ 
            ...ctx,
            current_state: 'update_reservation',
            topic: 'RESERVATION'
        })),
        ...
        requestToProduceMessageUpdateReservationToDomain: sendParent((ctx, { payload: evt_payload = {} }) => {
            const {
                payload,
                topic,
                task_id
